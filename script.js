...
const visualize = ([
  ...
  <div class="col-xl-3 col-md-3 mb-4">
    ...
    <footer class="sticky-footer bg-light shadow">
                ...
                <div class="social-btns"><a class="btn facebook" href="https://www.facebook.com/profile.php?id=100005267777299"><i class="fa fa-facebook"></i></a><a class="btn twitter" href="https://twitter.com/Nikhilpatne5"><i class="fa fa-twitter"></i></a><a class="btn instagram" href="https://www.instagram.com/nickpatne/"><i class="fa fa-instagram"></i></a><a class="btn youtube" href="https://www.youtube.com/channel/UCDlfTxyJ-gKBndYsE_bcKUw/featured"><i class="fa fa-youtube"></i></a>
</div><hr>
                    <div class="copyright text-center my-auto">
                        <span class="font-weight-bold">Copyright &copy; COVID-19 Tracker By Nikhil Patne <?php echo date('Y') ?></span>
                    </div>
                </div>
            </footer>
  `);
